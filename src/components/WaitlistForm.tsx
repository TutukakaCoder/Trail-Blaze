...
export default function WaitlistForm({ onSuccess, onClose }: WaitlistFormProps) {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white/5 backdrop-blur-lg rounded-2xl p-8 shadow-xl">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ 
          opacity: 1,
      ...
      >
        <h2 className="text-2xl font-bold text-white mb-6">Join Our Waitlist</h2>
